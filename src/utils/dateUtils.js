...
export function getPlayerLogo(id) { return `https://imagecache.365scores.com/image/upload/f_png,w_61,h_61,c_limit,q_auto:eco,dpr_2,d_Athletes:default.png,c_thumb,g_face,z_0.8/v13/Athletes/${id}` }